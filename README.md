...
is the Front End project. You can find the Front End project
here: [Candee Camp Front End](https://github.com/CandeeGenerations/candee-camp-fe).

This project is built with C#.
